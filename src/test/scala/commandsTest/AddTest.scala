...
class AddTest extends FunSpec with Matchers with BeforeAndAfter {
  ...
  describe("an add process") {
    ...
    it("should createBlob of file1 and add it to INDEX file"){
      ...
      index_file.getContent shouldBe file1.getPathFromDir(test_directory.getPath)+" "+file1.getUniqueKey+"\n"
    }
    ...
    it("should add all files"){
      ...
      val index_file_line_1_expected = file1.getPathFromDir(test_directory.getPath)+" "+file1.getUniqueKey
      val index_file_line_2_expected = file2.getPathFromDir(test_directory.getPath)+" "+file2.getUniqueKey
      val index_file_line_3_expected = file3.getPathFromDir(test_directory.getPath)+" "+file3.getUniqueKey
    ...
    it("should remove file1 from index when deleted but keep the blob"){
      ...
      //delete file from test_directory.getPath
      file1.deleteFile()
      ...
      val index_file_line_1_expected = file2.getPathFromDir(test_directory.getPath)+" "+file2.getUniqueKey
      val index_file_line_2_expected = file3.getPathFromDir(test_directory.getPath)+" "+file3.getUniqueKey
  ...
  describe("remove function"){
    it("should remove file1 from index when deleted but keep the blob") {
      ...
      Add.removeFileToIndex(file2.getPathFromDir(test_directory.getPath), test_directory.getPath)
