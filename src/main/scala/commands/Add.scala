...
object Add{
  ...
  def addFileToIndex(file_path_from_dir:String,actual_directory:File):Boolean = {
    val indexFile = new FileHandler(new File(actual_directory.getPath+"/.sgit/INDEX"))
    val fileToAdd = new FileHandler(new File(actual_directory.getPath+"/"+file_path_from_dir))
  ...
  def addFilesToIndex(actual_directory:File):Boolean={
    ...
    val index_file = new FileHandler(new File(actual_directory.getPath+"/.sgit/INDEX"))
  ...
  def removeFileToIndex(file_path_from_dir:String,actual_directory:File):Boolean = {
